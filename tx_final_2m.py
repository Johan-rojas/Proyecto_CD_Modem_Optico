...
class Tx:
    ...
    def _patron_fiducial(self) -> np.ndarray:
        """Patrón fiducial dinámico: marco blanco, centro negro.
        En el perfil 2 m se usa 9×9 para que las esquinas sean más visibles.
        """
    ...
    def _gen_img(self) -> None:
        ...
        for frame_cells in frames:
            ...
            # Atenuación visual para evitar blancos/colores saturados a 2 m.
            # No cambia la trama lógica; solo la intensidad mostrada.
            bordered = np.clip(bordered * TX_DISPLAY_GAIN, 0.0, 1.0)
    ...
    def draw(self, delay: float = 0.05, fullscreen: bool = True) -> None:
        ...
        if self.modulation == "ASK4_GRAY":
            ...
            print(f"CSK_REPEAT: {self.csk_repeat}")
            print("CSK/RGB usa pilotos de color y brillo reducido para evitar saturación.\n")
        else:
            print("")
