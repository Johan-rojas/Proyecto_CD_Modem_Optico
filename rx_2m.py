...
class Rx:
    ...
    def open_camera(self, cam_id=0):
        ...
        # Para 2 m no se fuerza FOCUS=0 porque en varias cámaras eso enfoca muy cerca.
        # Dejamos autofocus activo si el driver lo soporta.
        try:
        ...
        # Congelamos balance de blancos si la cámara lo permite.
        try:
